...
interface CoinGovernorInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class CoinGovernorInterface extends Contract {
  ...
  interface: CoinGovernorInterfaceInterface;
