...
interface CoinGovernorAlphaInterface extends ethers.utils.Interface {
  functions: {
...
export class CoinGovernorAlpha extends Contract {
  ...
  interface: CoinGovernorAlphaInterface;
