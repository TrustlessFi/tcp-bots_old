...
interface NonfungiblePositionManagerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "increaseLiquidity(uint256,uint128,uint256,uint256,uint256)": FunctionFragment;
...
export class NonfungiblePositionManager extends Contract {
  ...
  functions: {
    ...
    "increaseLiquidity(uint256,uint128,uint256,uint256,uint256)"(
      tokenId: BigNumberish,
      amount: BigNumberish,
      amount0Max: BigNumberish,
      amount1Max: BigNumberish,
    ...
    "mint((address,address,uint24,int24,int24,uint128,uint256,uint256,address,uint256))"(
      params: {
        token0: string;
        token1: string;
        fee: BigNumberish;
