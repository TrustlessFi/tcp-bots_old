...
interface TDaoNFTLockFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getAllReceivers()": FunctionFragment;
    "getContractsByReceiver(address)": FunctionFragment;
    "lockContractsByReceiver(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "lockContractsByReceiver",
...
export class TDaoNFTLockFactory extends BaseContract {
  ...
  functions: {
    ...
    getAllReceivers(overrides?: CallOverrides): Promise<[string[]]>;
  ...
  estimateGas: {
    ...
    getAllReceivers(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getAllReceivers(overrides?: CallOverrides): Promise<PopulatedTransaction>;
