...
interface CoinSafeCastTestableInterface extends ethers.utils.Interface {
  functions: {
    ...
    "_toUint112(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "_toUint112", data: BytesLike): Result;
...
export class CoinSafeCastTestable extends Contract {
  ...
  interface: CoinSafeCastTestableInterface;
  ...
  _toUint112(a: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
