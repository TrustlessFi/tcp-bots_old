...
import type { ITDao, ITDaoInterface } from "../ITDao";
...
export class ITDao__factory {
  static readonly abi = _abi;
  static createInterface(): ITDaoInterface {
    return new utils.Interface(_abi) as ITDaoInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ITDao {
    return new Contract(address, _abi, signerOrProvider) as ITDao;
  }
}
